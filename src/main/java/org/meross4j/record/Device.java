...
public record Device(@SerializedName(value = "deviceType") String deviceType,
                     ...
                     @SerializedName(value = "channels") ArrayList<Integer> channels, //check
                     @SerializedName(value = "bindTime") int bindTime,
                     ...
                     @SerializedName(value = "hardwareCapabilities") ArrayList<String> hardwareCapabilities,//check
